<%@ Page Title="" Language="C#" MasterPageFile="~/mainpage.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="Elibrary_Management_Project.adminpublishermanagement" %>
             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-4">
                              <asp:Label ID="Label1" runat="server" Text="Publisher ID"></asp:Label>
                                   <div class="mb-3">            
                         ...
                         <div class="col-md-8">
                                 <asp:Label ID="Label2" runat="server" Text="Publisher Name"></asp:Label>   
                                   <div class="mb-3"> 
                                       <asp:TextBox runat="server" CssClass="form-control" ID="TextBox2" placeholder="Publisher Name " ></asp:TextBox>
         ...
         <div class="col-md-7">
                 ...
                 <div class="card-body">
                     ...
                     <div class="row">
                         ...
                         <div class="row">
                             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryConnectionString %>" ProviderName="<%$ ConnectionStrings:elibraryConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [publisher_master_tbl]"></asp:SqlDataSource>
