    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                Label11.Text = dt.Rows[0]["account_status"].ToString().Trim();


                if (dt.Rows[0]["account_status"].ToString().Trim() == "active")
                {
                    Label11.Attributes.Add("class", "badge rounded-pill text-bg-success");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "pending")
                {
                    Label11.Attributes.Add("class", "badge rounded-pill text-bg-warning");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "deactive")
                {
                    Label11.Attributes.Add("class", "badge rounded-pill text-bg-danger");
                }
                else
                {
                    Label11.Attributes.Add("class", "badge rounded-pill text-bg-info");
                }
